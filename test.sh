...
test_program 4 "int main() { int i; i = 1; int n; n = sizeof(i);  return n; }"
test_program 8 "int main() { int *i; *i = 2; int n; n = sizeof(i);  return n; }"
test_program 8 "int main() { int **i; int n; n = sizeof(i);  return n; }"
test_program 4 "int main() { return sizeof 12; }"
test_program 17 "int main() { return sizeof 12 + 13; }"
test_program 4 "int main() { int *o; *o = 3; return sizeof(*o); }"
...
test_error "int main() { int a; *a = 6 * 3; int b; &b = a; return b; }" "ERROR: expected identifier, but got b"
test_error "int main() { int a; *a = 6 * 3; int b; &b = a; return b; }" "ERROR: expected identifier, but got b"
